...
<div class="header">
    ...
    <div class="title" id="titleString"><?php if($name): echo ($name); ?>-<?php endif; ?>项目经理列表</div>
...
<div class="container width80 pt20 ">
    <div class="control-group width100 clr">
        <?php if($info): ?><ul class="unstyled hotellist1 news_list" >

    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li class="li" style="padding-left: 5px">
            <!--<?php echo ($info["uid"]); ?>-->
            <?php if($count[$info['uid']]['project_sum']): ?><div class="radius50 color3 radiusStyle fl text_center transformXY">
                    <?php echo ($count[$info['uid']]['project_sum']); ?>
                </div><?php endif; echo ($info["alias"]); ?>
            <a href="index.php?s=/Home/Execution/project&id=<?php echo ($info["uid"]); ?>" class="glyphicon glyphicon-chevron-right fr color1 transform50"></a>
